...
station-goal-robot = 
    Цель вашей смены создание боргов и Рипли, а также постройке помещения с 4 зарядными станциями подсоединённых к сети.
    В каждом борге нужен как минимум 2 обычных и 1 улучшеный модуль.
